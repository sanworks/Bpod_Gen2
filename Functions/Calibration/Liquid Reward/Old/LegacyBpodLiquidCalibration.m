...
if ~isempty(ValveIDs)
    ...
    if Completed
        ...
        image(BG); axis off;
        BpodSystem.GUIHandles.LiquidCalibrator.CB1b = uicontrol('Style', 'edit', 'Position', [155 379 80 35],... 
            'TooltipString', 'Enter liquid weight for valve 1', 'FontWeight', 'bold', 'FontSize', 12,...
            'BackgroundColor', [.9 .9 .9], 'ForegroundColor', [0.1 0.1 0.1]);
        BpodSystem.GUIHandles.LiquidCalibrator.CB2b = uicontrol('Style', 'edit', 'Position', [155 336 80 35],... 
            'TooltipString', 'Enter liquid weight for valve 2', 'FontWeight', 'bold', 'FontSize', 12,... 
            'BackgroundColor', [.9 .9 .9], 'ForegroundColor', [0.1 0.1 0.1]);
        BpodSystem.GUIHandles.LiquidCalibrator.CB3b = uicontrol('Style', 'edit', 'Position', [155 293 80 35],... 
            'TooltipString', 'Enter liquid weight for valve 3', 'FontWeight', 'bold', 'FontSize', 12, ... 
            'BackgroundColor', [.9 .9 .9], 'ForegroundColor', [0.1 0.1 0.1]);
        BpodSystem.GUIHandles.LiquidCalibrator.CB4b = uicontrol('Style', 'edit', 'Position', [155 250 80 35],... 
            'TooltipString', 'Enter liquid weight for valve 4', 'FontWeight', 'bold', 'FontSize', 12,... 
            'BackgroundColor', [.9 .9 .9], 'ForegroundColor', [0.1 0.1 0.1]);
        BpodSystem.GUIHandles.LiquidCalibrator.CB5b = uicontrol('Style', 'edit', 'Position', [155 207 80 35],... 
            'TooltipString', 'Enter liquid weight for valve 5', 'FontWeight', 'bold', 'FontSize', 12,... 
            'BackgroundColor', [.9 .9 .9], 'ForegroundColor', [0.1 0.1 0.1]);
        BpodSystem.GUIHandles.LiquidCalibrator.CB6b = uicontrol('Style', 'edit', 'Position', [155 164 80 35],... 
            'TooltipString', 'Enter liquid weight for valve 6', 'FontWeight', 'bold', 'FontSize', 12,... 
            'BackgroundColor', [.9 .9 .9], 'ForegroundColor', [0.1 0.1 0.1]);
        BpodSystem.GUIHandles.LiquidCalibrator.CB7b = uicontrol('Style', 'edit', 'Position', [155 121 80 35],... 
            'TooltipString', 'Enter liquid weight for valve 7', 'FontWeight', 'bold', 'FontSize', 12,... 
            'BackgroundColor', [.9 .9 .9], 'ForegroundColor', [0.1 0.1 0.1]);
        BpodSystem.GUIHandles.LiquidCalibrator.CB8b = uicontrol('Style', 'edit', 'Position', [155 78 80 35],... 
            'TooltipString', 'Enter liquid weight for valve 8', 'FontWeight', 'bold', 'FontSize', 12,... 
            'BackgroundColor', [.9 .9 .9], 'ForegroundColor', [0.1 0.1 0.1]);
...
if InvalidParams == 0
    ...
    PulseDurations = LegacyBpodLiquidCalibration('GetValveTimes', LiquidAmount, TargetValves);
