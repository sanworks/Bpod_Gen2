...
% StateMachinePanel_2Plus() sets up the state machine panel on the 
...
BpodSystem.GUIHandles.AnalogViewerButton = uicontrol('Parent', BpodSystem.GUIHandles.OverridePanel(1),...
    'Style', 'pushbutton', 'String', '', 'Position', [390 120 160 80], 'Callback', 'BpodSystem.startAnalogViewer();',... 
    'CData', BpodSystem.GUIData.AnalogViewerButton, 'TooltipString', 'Launch Analog Viewer');
