...
prog1 = S.addMovement(prog1, 'Channel', 1,...            % Target motor channel (1-3)
                             ...
                             'MaxVelocity', 500,...      % units = RPM, use 0 for max
                             'MaxAcceleration', 100,...  % units = rev/min^2, use 0 for max
...
prog1 = S.setLoopDuration(prog1, 15); % Loop the program for 15 seconds
