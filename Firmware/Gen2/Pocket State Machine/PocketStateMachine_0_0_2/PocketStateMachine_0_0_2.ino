...
//
// Note: If compiling for Arduino Due (Bpod 0.5-0.8) this firmware requires a small modification to Arduino, for useful PWM control of light 
// intensity with small (1-10ms) pulses:
