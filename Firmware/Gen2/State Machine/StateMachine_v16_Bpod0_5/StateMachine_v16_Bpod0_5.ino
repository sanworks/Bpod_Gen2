...
#elif MachineType == 3 // Teensy 3.6-based "Pocket" state machine
...
#elif MachineType == 3  // Teensy 3.6 based state machines (Pocket state machine)
  ...
  for (int i = 0; i < nInputs; i++) {
    switch (InputHW[i]) {
      ...
      case 'W':
        ...
        inputEnabled[i] = 1;
        #if MachineType > 1 // NOTE: Previously if FirmwareVerison > 6 (0.7+ but not 0.5 or Pocket)
          inputState[i] = 1;
          lastInputState[i] = 1;
        #endif
