...
//JPL - adding support for HED-style optical encoder
...
char encoderType[] = "HEB";          //  Modle number for encoder. Must be supported by one of the encoder libs  
...
//JPL - here we will want to call different libs depending on encoderType

switch encoderType


  case "Broadcom_HEDS-5500_6500"

    #include "Broadcom_HEDS-5500_6500.h"

  case "Yumo_E6B2-CWZ3E"
...
boolean sendEvents = false; // True if sending threshold crossing events to state machine
