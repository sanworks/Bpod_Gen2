...
class stateMachine(object):
    def __init__(self, bpodObject):
        ...
        self.globalTimers.loopMode = [0]*bpodObject.HW.n.GlobalTimers
        self.globalTimers.loopIntervals = [0]*bpodObject.HW.n.GlobalTimers
        self.globalTimers.sendEvents = [0]*bpodObject.HW.n.GlobalTimers
                ...
                for i in range(0,nactions,2):
                    ...
                    if thisAction in self.metaOutputNames:
                        ...
                        if metaAction == 0: # Valve
                            thisOutputCode = self.outputChannelNames.index('ValveState')
                            thisOutputValue = int(math.pow(2,value-1))
    ...
    def setGlobalTimer(self, *args):
        ...
        for i in range(0,nargs,2):
            ...
            if thisArg == 'timerid':
                ...
                loopMode = thisArgValue
            elif thisArg == 'sendglobaltimerevents':
                timerEvents = thisArgValue
            elif thisArg == 'loopinterval': 
                loopInterval = thisArgValue
            else:
        ...
        self.globalTimers.loopMode[timerID-1] = loopMode
        self.globalTimers.loopIntervals[timerID-1] = loopInterval
        self.globalTimers.sendEvents[timerID-1] = timerEvents
